 ...
 */
let JsonFilterPipe = class JsonFilterPipe {
...
exports.JsonFilterPipe = JsonFilterPipe;
exports.JsonFilterPipe = JsonFilterPipe = __decorate([
    (0, core_1.Pipe)({
        name: 'jsonFilter'
    })
], JsonFilterPipe);
